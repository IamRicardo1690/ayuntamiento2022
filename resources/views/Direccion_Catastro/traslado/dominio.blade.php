            ...
            <div class="col-md-12">
                <div class="page-header">
                    <h5>
                        ...
                        {{ Form::open(['route' => 'traslado', 'method' => 'GET', 'class' => 'form-inline pull-right']) }}
                        ...
                        <tbody id=grupos>
                            ...
                            @foreach($datos as $fila)
                                <tr>
                                 ...
                                 {{--   <td><a class="btn btn-warning" href="{{ url('imprimircita' , $fila->id_ciudadano)}} ">Imprimir</td>--}}
                                </tr>
                            @endforeach 
