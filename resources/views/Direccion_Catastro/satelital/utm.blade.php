        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-header" align="center">
                    {{ __('IMAGEN SATELITAL CON COORDENADAS UTM') }}
                <h6>
            ...
            <div class="col-md-12">
                <div class="page-header">
                    <h5>
                        ...
                        {{ Form::open(['route' => 'satelital', 'method' => 'GET', 'class' => 'form-inline pull-right']) }}
                        ...
                        <tbody id=grupos>
                             @foreach($datos as $fila)
                                <tr>
                                    ...
                                    {{--<td><a class="btn btn.small btn-warning" href="{{ Route('imprimircita') }}">Imprimir</td>--}}
                                </tr>
                            @endforeach 
